...
app.get('/usuario', vertificaToken, (req, res) => {
...
app.put('/usuario/:id', [vertificaToken, verificaRolAdmin], function(req, res) {
...
app.delete('/usuario/:id', [vertificaToken, verificaRolAdmin], function(req, res) {
